...
WSGI_APPLICATION = 'sttcustom.wsgi.application'
...
db_from_env = dj_database_url.config(default='postgresql://postgres:postgres@localhost:5432/sttcustom',
                                     conn_max_age=600)
